...
# Generate output-dra.yaml (Dynamic Resource Allocation deployment for two Gaudi3 devices)
generate_output "dra" "examples/values-dra.yaml" "examples/output-dra.yaml" '--set modelArtifacts.uri=pvc+hf://model-pvc/meta-llama/Llama-3.3-70B-Instruct'
