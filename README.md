...
| `multinode`                            | Determines whether to create model workloads using Deployments (false) or LeaderWorkerSets (true)                 | bool            | `false`                                     |
...
| `routing.proxy.connector`              | Deprecated KV connector setting; use `routing.proxy.kvConnector` instead                                          | string          | `nixlv2`                                    |
| `routing.proxy.kvConnector`            | KV connector passed to the decode routing sidecar; falls back to the deprecated `connector` field                 | string          | `""`                                     |
| `routing.proxy.ecConnector`            | Optional EC connector passed to the decode routing sidecar                                                        | string          | `""`                                        |
...
| `encode`                               | Same fields supported in `decode`                                                                                 | See above       | See above                                   |
| `encode.resourceClaims`                | List of non-accelerator ResourceClaims to create and attach to encode pods                                        | List            | []                                          |
